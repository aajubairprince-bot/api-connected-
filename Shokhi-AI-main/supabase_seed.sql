-- ==============================================================================
-- 🌸 Shokhi AI (সখী AI) — Mock & Seed Data for Supabase PostgreSQL
-- Run this script in your Supabase SQL Editor after running supabase_schema.sql
-- ==============================================================================

-- 1. Seed Standalone / Admin Users (Table: users or profiles)
-- Note: Replace UUIDs if referencing actual auth.users, or use these mock user identifiers:
...
BEGIN
    ...
    -- 6. Seed Prenatal Doctor Appointments
    ...
    -- 7. Seed Maternal Vital Records (Blood Pressure & Weight)
    ...
    -- 9. Seed Fetal Kick Monitoring Records
    ...
    -- 11. Seed Dynamic Notifications & Reminders
    ...
    -- 12. Seed Obstetric Emergency Audit Logs
